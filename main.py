...
# Assuming you know the columns that represent warehouses "Chak 149","KDukaan",
warehouse_columns = ['Athara Hazari', 'Bhowana', 'Chund Bharwana',  "Lallian", "Hafizabad",   "Garrh Maharaja", "Other"]  # Add all your warehouse columns here
